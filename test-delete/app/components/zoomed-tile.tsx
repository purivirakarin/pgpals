...
export const ZoomedTile = memo<ZoomedTileProps>(
  ({ tileIndex, isFlipped, activity, bgPosition }) => {
    return (
          ...
          <div className={cn("relative w-full h-full", styles.preserve3d)}>
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-b from-amber-50 via-stone-50 to-amber-100 rounded-lg border-2 border-stone-300 shadow-2xl flex items-center justify-center relative overflow-hidden">
                ...
                {/* Traditional mahjong decorative corners */}
                ...
                <div className="relative z-10 text-stone-700 font-semibold text-lg text-center px-4 leading-tight drop-shadow-sm">
                  {activity.task}
                </div>
                <div className="absolute bottom-3 right-3 bg-emerald-500 text-white text-sm font-bold px-3 py-1 rounded-full shadow-md border border-emerald-300">
                  {activity.points} pts
                </div>
              </div>
            </div>
            ...
            >
              {/* Back of tile - showing portion of the PGP logo */}
              <div className="w-full h-full bg-gradient-to-b from-emerald-600 via-emerald-500 to-emerald-700 rounded-lg border-2 border-emerald-400 shadow-2xl flex items-center justify-center relative overflow-hidden">
                ...
                {/* Traditional mahjong decorative corners in emerald */}
                ...
                {/* Portion of PGP logo background */}
                <div
                ...
                <div className="absolute bottom-3 right-3 bg-emerald-200 text-emerald-800 text-sm font-bold px-3 py-1 rounded-full shadow-md">
                  {activity.points} pts
                </div>
